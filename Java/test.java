...
public class test
{
	static void DigitalSignature1Example(String input) throws Exception
	{
		...
		System.out.println( Base64.encodeToString(md, Base64.DEFAULT) );
		//
		...
		System.out.println( Base64.encodeToString(cipherText, Base64.DEFAULT) );
		//
		...
		System.out.println( Base64.encodeToString(newMD, Base64.DEFAULT) );
		//
